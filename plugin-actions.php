<?php
/*
Plugin Name: Plugin Action Links
Plugin URI: https://github.com/sazzadmahmud85
Description: This is a demo of Plugin Action Links. 
Version: 1.0
...
add_filter( 'plugin_row_meta', function ( $links, $plugin ) {
	if ( plugin_basename( __FILE__ ) == $plugin ) {
		$link = sprintf( "<a href='%s' style='color:#ff3c41;'>%s</a>", esc_url( 'https://github.com/sazzadmahmud85' ), __( 'Fork on Github', 'plac' ) );
		array_push( $links, $link );
	}
